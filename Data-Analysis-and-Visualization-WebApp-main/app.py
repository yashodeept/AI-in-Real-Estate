...
if selected == 'Home':
    st.markdown("<h1 style='color: #FF5733';><em>Data Analysis and Data Visualization WebApp!</em></h1>", unsafe_allow_html=True)
    st.write('Transforming the way we buy, sell and manage properties.')
    st.image('image12.jpg')
    st.markdown("<h2 style='color: #FF5733';><em>Overview :</em></h2>", unsafe_allow_html=True)
    st.write('A Data Analysis and Data Visualization WebApp is an interactive platform designed to process and present data insights in an intuitive manner. It allows users to upload datasets, perform statistical analyses, and visualize results through charts, graphs, and dashboards. The app helps uncover trends, patterns, and correlations in data, aiding in informed decision-making. Common features include data filtering, aggregation, and customization of visualizations. Users can interact with data dynamically, such as zooming into charts or applying filters. Built using technologies like Python (Flask/Django), JavaScript (D3.js/Chart.js), and libraries like Pandas and Matplotlib, it serves diverse industries like finance, healthcare, and marketing. These tools enhance accessibility and understanding of complex datasets for both technical and non-technical users.')
